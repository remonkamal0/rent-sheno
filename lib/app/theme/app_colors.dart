...
extension ThemeColors on BuildContext {
  ...
  Color get primaryTextColor =>
      isDarkMode ? Colors.white : AppColors.primaryText;
  Color get secondaryTextColor =>
      isDarkMode ? Colors.white70 : AppColors.secondaryText;
  Color get cardColor =>
      isDarkMode ? const Color(0xFF1E293B) : AppColors.cardBackground;
