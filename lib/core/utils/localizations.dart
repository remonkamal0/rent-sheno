...
class AppLocalizations {
  ...
  static const _localizedValues = {
    'en': {
      ...
      'sent_messages_desc': 'Review all announcements and notices dispatched to tenants with timestamp details.',
      'sent_to': 'Sent to',
      'search_messages_hint': 'Search title, message, resident, or unit #...',
      'no_sent_messages': 'No Sent Messages Found',
      'total_sent': 'Total Dispatched: {}',
      'filter_type': 'Type',
      'all_types': 'All Types',
    ...
    'es': {
      ...
      'sent_messages_desc': 'Revise todos los anuncios y avisos enviados a los inquilinos con detalles de fecha y hora.',
      'sent_to': 'Enviado a',
      'search_messages_hint': 'Buscar título, mensaje, residente o n.° de unidad...',
      'no_sent_messages': 'No se encontraron mensajes enviados',
      'total_sent': 'Total enviados: {}',
      'filter_type': 'Tipo',
      'all_types': 'Todos los tipos',
      'general_announcement': 'Anuncio general',
      'payment_alert': 'Alerta de pago',
    ...
    'ar': {
      ...
      'sent_messages_history': 'سجل الرسائل والإشعارات المرسلة',
      'sent_messages_desc': 'استعراض كافة الإعلانات والرسائل المرسلة للسكان مع تفاصيل الوقت والتاريخ.',
      'sent_to': 'مرسل إلى',
      'search_messages_hint': 'ابحث بالعنوان، نص الرسالة، اسم الساكن، أو رقم الشقة...',
      'no_sent_messages': 'لا توجد رسائل أو إشعارات مرسلة',
      'total_sent': 'إجمالي الرسائل المرسلة: {}',
      'filter_type': 'النوع',
      'all_types': 'جميع الأنواع',
      'general_announcement': 'إعلان عام',
      'payment_alert': 'تنبيه سداد',
